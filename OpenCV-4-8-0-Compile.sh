...
sudo apt-get install -y libgstreamer-plugins-bad1.0-dev gstreamer1.0-plugins-ugly
sudo apt-get install -y gstreamer1.0-tools gstreamer1.0-gl gstreamer1.0-gtk3
